...
String item = "0";
const char* ssid = "Superkurt";
const char* password = "123thomaskurt321";
...
void setup() {
  ...
  ledcAttach(fanPin2, 5, 8);  //Bind the LEDC channel 1 to the specified left motor pin GPIO26 for output.  
  ...
  ledcAttach(PWM_Pin1, channel_PWM, resolution_PWM);  //Binds the LEDC channel to the specified IO port for output
  ledcAttach(PWM_Pin2, channel_PWM2, resolution_PWM);  //Binds the LEDC channel to the specified IO port for output
